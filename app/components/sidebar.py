        ...
        dbc.Collapse(
            dbc.Nav(
                [
                    ...
                    dbc.NavLink("Sentiment Score", href="/agile/ai-adoption", id="sentiment-score-link", active="exact"),
                    dbc.NavLink("ROI", href="/agile/roi", id="roi-link", active="exact"),
                    dbc.NavLink("Adoption %", href="/agile/adoption-percent", id="adoption-percent-link", active="exact"),
                    dbc.NavLink("Maturity Stage", href="/agile/maturity", id="maturity-stage-link", active="exact"),
                ],
                vertical=True,
                pills=True,
            ),
