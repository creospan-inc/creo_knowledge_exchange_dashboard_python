        ...
        dbc.Collapse(
            dbc.Nav(
                [
                    ...
                    dbc.NavLink("Maturity Stage", href="/ai/maturity", id="maturity-stage-link", active="exact"),
                    dbc.NavLink("Model Performance", href="/ai/velocity", id="velocity-link", active="exact"),
                    dbc.NavLink("User Engagement", href="/ai/cycle-time", id="cycle-time-link", active="exact"),
                    dbc.NavLink("Cost to Serve", href="/ai/sprint-burndown", id="sprint-burndown-link", active="exact"),
